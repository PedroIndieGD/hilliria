...
public class escolher_fase : MonoBehaviour {
	...
	void OnGUI (){
		...
		{
		if(GUI.Button(new Rect(Screen.width/2 + 500, Screen.height/2 , 100, 90), "Proximo")){
		...
		{
		if(GUI.Button(new Rect(Screen.width/2 - 550, Screen.height/2 , 100, 90), "Anterior")){
		...
		if(GUI.Button(new Rect(Screen.width/2 - 250, Screen.height/2 + 250, 500, 100), "Selecionar"))
		{
